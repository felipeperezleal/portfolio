  ...
  return (
    <div className='h-screen flex items-center justify-around'>
      <div className='flex flex-col p-20 items-start justify-evenly h-full'>
        <div>
          <p className='text-4xl text tracking-tight font-medium md:text-7xl'>{"Hello, I'm Felipe Pérez Leal."}</p>
          <p className='text-1xl tracking-widest py-10 md:text-3xl'>SOFTWARE  DEVELOPER</p>
        </div>
